...
module.exports = {
  name: "seek",
  description: "Définit la position des pistes de lecture à la position spécifiée",
  category: "MUSIC",
...
function seekTo({ client, guildId }, time) {
  ...
  player.seek(seekTo);
  return `Cherché à ${prettyMs(seekTo, { colonNotation: true, secondsDecimalDigits: 0 })}`;
}
